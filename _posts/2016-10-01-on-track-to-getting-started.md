...
Once a week, hopefully every Saturday, I will be creating a post with a table like the one below<a name="cont-1" href="#fn-1"><sup class="">[1]</sup></a>
...
<h4>Footnotes</h4>
<ol class="footnotes">
  <li>This post will only have this one week, but from now on I will keep four weeks consistent in a post and a monthly average at the bottom of each post. <a name="fn-1" href="#cont-1">⏎</a></li>
</ol>
